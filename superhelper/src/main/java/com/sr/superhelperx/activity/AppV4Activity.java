    ...
    public void setContentViewAsy(final int layoutResID, final AppAsyLayoutCallBack appAsyLayoutCallBack) {
        ...
        UtilAsyView var10001 = new UtilAsyView() {
            protected View handler() {
                return ScaleScreenHelperFactory.getInstance().loadViewGroup((ViewGroup) BoundViewHelper.boundView(AppV4Activity.this, AppV4Activity.this.getLayoutInflater().inflate(layoutResID, (ViewGroup)null)));
            }
            ...
            protected void result(View view) {
                ...
                try {
                    ...
                    AppV4Activity.this.onAsyLayoutInit(AppV4Activity.this.b);
                }
