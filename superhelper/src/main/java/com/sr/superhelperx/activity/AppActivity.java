    ...
    public void setContentViewAsy(final int layoutResID, final AppAsyLayoutCallBack appAsyLayoutCallBack) {
        ...
        UtilAsyView var10001 = new UtilAsyView() {
            protected View handler() {
                return ScaleScreenHelperFactory.getInstance().loadViewGroup((ViewGroup) BoundViewHelper.boundView(AppActivity.this, AppActivity.this.getLayoutInflater().inflate(layoutResID, (ViewGroup)null)));
            }
            ...
            protected void result(View view) {
                ...
                try {
                    ...
                    AppActivity.this.onAsyLayoutInit(AppActivity.this.b);
                }
