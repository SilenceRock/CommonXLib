package com.sr.superhelperx.imagepicker;

import android.app.Activity;
import android.content.Intent;


import com.sr.superhelperx.imagepicker.activity.ImagePickerActivity;
import com.sr.superhelperx.imagepicker.manager.ConfigManager;
import com.sr.superhelperx.imagepicker.utils.ImageLoader;
...
public class ImagePicker {
     ...
     * @return
     */
    public ImagePicker setVideoCount(int maxCount){
        ConfigManager.getInstance().setVideoMaxCount(maxCount);
        return mImagePicker;
    }
     ...
     * @return
     */
    public ImagePicker setImageCount(int maxCount) {
        ConfigManager.getInstance().setImageMaxCount(maxCount);
        return mImagePicker;
    }
