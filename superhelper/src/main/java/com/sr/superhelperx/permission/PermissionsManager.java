...
/**
 * Created by Hang.Yang on 2018/8/17 14:23.
...
public class PermissionsManager {
    ...
    private final ArrayList<PermissionsResultAction> mPendingActions = new ArrayList(1);
...
//        }
        ...
        while(true) {
            PermissionsResultAction resultAction;
            do {
                if(!iterator.hasNext()) {
                    return;
                }

                resultAction = (PermissionsResultAction) iterator.next();
            } while(resultAction != action && resultAction != null);
    ...
    public synchronized void requestPermissionsIfNecessaryForResult(@NonNull android.app.Fragment fragment, @NonNull String[] permissions, @Nullable PermissionsResultAction action) {
